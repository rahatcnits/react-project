...
export default function Quiz() {
    ...
    // handle when user clicks the prev button to get back to the previous questions
    ...
    return(
        ...
        {!loading && !error && qna && qna.length > 0 && (
            <>
                ...
                <ProgressBar next={nextQuestion} prev={prevQuestion} submit={submit} progress={parcentage} />
                <MiniPlayer />
            </> )}   
        </>
    );
